...
const GOOGLE_SHEETS_URL = import.meta.env.VITE_ALLERGENS_SHEET_URL || 'https://script.google.com/macros/s/AKfycbwmSfN7KKDheU7KVXD3EyYkCApSN_Git6XgnG6yHaX7QENXlHlrvngCzHO582yVE68gHA/exec'
