...
const GOOGLE_SHEETS_URL = import.meta.env.VITE_PROVING_METHODS_SHEET_URL || 'https://script.google.com/macros/s/AKfycbxCuLVrqdTBnjPZpbMVyWArCR78Iq6fi6a8vGTZTJSAFjcL65J934tcHp23Z0Oxr4dbhw/exec'
